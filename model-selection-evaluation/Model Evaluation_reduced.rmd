...
df$Hour_13 <- df$Hour == 13
df$Hour_15 <- df$Hour == 15
df$Hour_16 <- df$Hour == 16
df$Hour_22 <- df$Hour == 22
# select only useful stuff
df <- df %>% dplyr::select(y, Month_aug, Month_dec, Month_jul, Month_jun,
...
```{r}
model <- readRDS(file = "./model-selection-evaluation/Logistic_regression_reduced.rds")
...
```{r}
model <- readRDS(file = "./model-selection-evaluation/KNN_only_significant.rds")
...
```{r}
model <- readRDS(file = "./model-selection-evaluation/LDA_only_significant.rds")
...
```{r}
model <- readRDS(file = "./model-selection-evaluation/Naive_Bayes_only_significant.rds")
predictions <- predict(model, df) # predictions
...
# Tree
```{r}
model <- readRDS(file = "./model-selection-evaluation/Simple_Tree_only_significant.rds")
...
# Simple tree (pruned)
```{r}
model <- readRDS(file = "./model-selection-evaluation/Pruned_Tree_only_significant.rds")
predictions <- predict(model, df, type = "class") # predictions
...
```{r}
model <- readRDS(file = "./model-selection-evaluation/Bagging_only_significant.rds")
predictions <- predict(model, df, type = "class") # predictions
...
model <- readRDS(file = "./model-selection-evaluation/Random_Forest_only_significant.rds")
predictions <- predict(model, df, type = "class") # predictions
...
model <- readRDS(file = "./model-selection-evaluation/Boosting_only_significant.rds")
...
```{r}
model <- readRDS(file = "./model-selection-evaluation/Maximal_margin_classifier_only_significant.rds")
...
```{r}
model <- readRDS(file = "./model-selection-evaluation/Support_vector_classifier_only_significant.rds")
predictions <- predict(model, df_tree, probability = TRUE) # predictions
...
## Radial
```{r}
model <- readRDS(file = "./model-selection-evaluation/Support_vector_machine_radial_only_significant.rds")
predictions <- predict(model, df_tree, probability = TRUE) # predictions
...
```{r}
model <- readRDS(file = "./model-selection-evaluation/Support_vector_machine_sigmoid_only_significant.rds")
predictions <- predict(model, df_tree, probability = TRUE) # predictions
...
```{r}
model <- readRDS(file = "./model-selection-evaluation/Support_vector_machine_polynomial_only_significant.rds")
predictions <- predict(model, df_tree, probability = TRUE) # predictions
